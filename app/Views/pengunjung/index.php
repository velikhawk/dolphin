...
<div class="row">
    <div class="col-6">
        <a href="/pengunjung/tambah" class="btn btn-primary btn-icon-split mb-3">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw  fa-user-circle"></i> Data Pengunjung</h6>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    <?php foreach ($pengunjung as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="/pengunjung/edit/<?= $row['idpengunjung']; ?>" class="badge badge-primary">Edit</a>
                           
                                <form action="/pengunjung/delete/<?= $row['idpengunjung']; ?>" method="POST" class="d-inline">
                                    <?= csrf_field(); ?>
