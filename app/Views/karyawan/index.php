...
<div class="row">
    <div class="col-6">
        <a href="/karyawan/tambah" class="btn btn-primary btn-icon-split mb-3">
                ...
                <tbody>
                    <?php foreach ($karyawan as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row['telp']; ?></td>
                            <td>
                                <a href="/karyawan/edit/<?= $row['idkaryawan']; ?>" class="badge badge-primary">Edit</a>

                                <form action="/karyawan/delete/<?= $row['idkaryawan']; ?>" method="POST" class="d-inline">
                                    <?= csrf_field(); ?>
